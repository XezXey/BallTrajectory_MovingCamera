...
if __name__ == '__main__':
  ...
  dataloader_test = DataLoader(dataset_test, batch_size=args.batch_size, num_workers=10, shuffle=True, collate_fn=partial(collate_fn_padd, set_='test'), pin_memory=True, drop_last=False)
